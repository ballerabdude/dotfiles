...
bot "Would you like to install other programs and auto set some configurations"

echo "Answer no if you just want the basics"
bot "Don't worry you can always comeback and run the osx.sh"
...
if [[ $response =~ ^(yes|y|Y) ]];then
    ...
    require_cask alfred
    brew cask alfred link #For alferd
